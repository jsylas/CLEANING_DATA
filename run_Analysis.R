...
setwd("C:/Users/jsylas/Desktop/R/Getting_And_Cleaning_Data/project/UCI HAR Dataset")
#for melt and cast function
...
write.table(file="getdata_proj_tidy_final1.txt",x=fdf.cast,row.name=FALSE)
